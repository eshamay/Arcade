...
namespace morita {
	...
	class MoritaH2O : public Water {
		public:
			...
			// used for geometric determination of the polarizability and dipole moments as in the 2002 morita/hynes paper
			void SetBondAngleVars ();
			void CalculateGeometricalDipoleMoment ();
		...
		protected:
			...
			MatR _alpha;	// total polarizability of the water molecule
